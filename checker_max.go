...
func (c *maxChecker) Check(v interface{}, expects string) errors.Error {
...
func (c *maxChecker) checkInt(v interface{}, expects int64) errors.Error {
	i, err := IsInt(v)
	if err != nil {
		return err
	}
...
func (c *maxChecker) checkFloat(v interface{}, expects float64) errors.Error {
	f, err := IsFloat(v)
	if err != nil {
		return err
	}
